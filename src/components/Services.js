...
const Services = () => {
    const services = [
        ...
        {
            title: 'הסרת שיער',
            description: 'הסרת שיער עדינה ומקצועית לפנים, כולל טיפול בשפם.',
            icon: Scissors
        }
    ];
    ...
    return (
        <div className="container mx-auto px-4 py-16 bg-gradient-to-r from-primary-light to-secondary-light">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-center text-primary font-secondary">השירותים שלי</h2>
